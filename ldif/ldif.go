// A basic LDIF parser (RFC 2849). This one currently just supports LDIFs like
// they are generated by tools like ldapsearch(1) / slapcat(8). Change records are
// not supported while unmarshalling. For marshalling support for mod(r)dn
// is missing.
//
